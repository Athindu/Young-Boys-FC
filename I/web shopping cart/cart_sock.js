                ...
                if (email != ""){
                    if (TP != ""){
                        if (qty1 > 0){
                            ...
                            purchase = purchase + "	Puma(Striped Version) :  " + qty1 + " * " + price1 + " = " + (price1 * qty1) + "\n";
                        }
                        if (qty2 > 0){
                            total = total + (price2 * qty2);
                            purchase = purchase + "	Nike :  " + qty2 + " * " + price2 + " = " + (price2 * qty2) + "\n";
                        }
                        if (qty3 > 0){
                            total = total + (price3 * qty3);
                            purchase = purchase + "	Nike :  " + qty3 + " * " + price3 + " = " + (price3 * qty3) + "\n";
                        }
